...
type Application = Timestamps & { id: string; job_id: string; applicant_id: string; resume_id: string | null; cover_letter: string | null; status: Database['public']['Enums']['application_status']; notes: string | null };
